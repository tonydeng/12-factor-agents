...
### 12. 将你的智能体变成无状态的Reducer

好的，到这个时候我们已经超过1000行Markdown了。这一条主要是为了好玩。
...
[← 从任何地方触发](https://github.com/humanlayer/12-factor-agents/blob/main/content/factor-11-trigger-from-anywhere-zh.md) | [附录 - 预取上下文 →](https://github.com/humanlayer/12-factor-agents/blob/main/content/appendix-13-pre-fetch-zh.md)
