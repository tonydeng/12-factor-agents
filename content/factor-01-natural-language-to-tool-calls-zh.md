...
从这里开始，确定性代码可以获取有效载荷并对其执行操作。（更多内容见[因素3](./factor-03-own-your-context-window-zh.md)）
...
[← 我们是如何走到这里的](./brief-history-of-software-zh.md) | [掌控你的提示词 →](./factor-02-own-your-prompts-zh.md)
